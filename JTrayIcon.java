...
public class JTrayIcon extends TrayIcon {
    ...
    private static JPopupMenu jp;
    private static JTrayIcon jtrayicon;
    static {
	...
	public static void main(String args[])
	{
		...
		dogImage  = Toolkit.getDefaultToolkit().getImage("new1.jpg");
		SwingUtilities.invokeLater(new Runnable(){
                        public void run() {
                                new JTrayIcon(dogImage);
                        }
                });
		//jtrayicon = new JTrayIcon(dogImage);
	}
}
